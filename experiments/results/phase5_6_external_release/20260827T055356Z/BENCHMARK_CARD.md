...
**MIT** — see `LICENSE` in this directory. Decided by the project owner
on 2026-08-27, after `LICENSE_PROVENANCE_AUDIT.md` (Phase 5.6 release
directory) confirmed all benchmark code is self-authored with no
upstream-license conflict. The bundled dataset sample under this
package's `experiments/` directory is dataset content and remains
licensed separately under CC BY 4.0, not MIT.
